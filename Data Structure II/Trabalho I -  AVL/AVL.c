...
AVL *remove_AVL(AVL *node, void *element, int (compare) (void *, void *)){
    ...
    // caso onde a remoção ocorre pela direita, olha-se o balanceamento da esquerda,
    // e o balanceamento da raiz da subárvore esquerda me dirá qual o tipo de rotação
    // a ser feita. 
    int j = 0;
